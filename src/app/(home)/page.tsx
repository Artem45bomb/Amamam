...
export default function Home() {
  return (<div style={{backgroundImage:`url("/png/bg-product.png")`,backgroundRepeat:'no-repeat'}} className={'bg-background'}>
        <div className={'w-full px-20 pt-16 min-h-[35rem]'}>
